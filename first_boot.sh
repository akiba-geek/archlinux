...
LANG=C yay --noprovides --answerdiff None --answerclean None --mflags "--noconfirm" -S dracut-ukify waterfox-bin ungoogled-chromium-bin slack-desktop notion-app-electron sddm-slice-git nvim-packer-git
